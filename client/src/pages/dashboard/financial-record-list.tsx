...
interface EditableCellProps extends CellProps<FinancialRecord> {
    updateRecord: (rowIndex: number, columnId: string, value: any) => any;
    editable: boolean;
}
        ...
        () => [
            {
                ...
                Cell: (props: any) => <EditableCell {...props} updateRecord={updateCellRecord} editable={true} />
            },
            {
                Header: 'Amount',
                accessor: 'amount',
            ...
            },
            {
                Header: 'Date',
                accessor: 'date',
                Cell: (props: any) => <EditableCell {...props} updateRecord={updateCellRecord} editable={false} />
            },
            {
                Header: 'Delete',
                id: 'delete',
